...
public class InstanceOf : MonoBehaviour
{
    ...
    {
        using (var request = UnityWebRequest.Get("https://wordsapiv1.p.rapidapi.com/words/"+ word +"/instanceOf"))
        {
    ...
    KeyValuePair<string, List<string>> ParseJson(string json)
    {
        ...
        var keyValue = new KeyValuePair<string, List<string>>(jsonData.word, jsonData.instanceOf.ToList());
        return keyValue;
    }
}
