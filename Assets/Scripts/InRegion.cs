...
public class InRegion : MonoBehaviour
{
    ...
    {
        using (var request = UnityWebRequest.Get("https://wordsapiv1.p.rapidapi.com/words/"+ word +"/inRegion"))
        {
    ...
    KeyValuePair<string, List<string>> ParseJson(string json)
    {
        ...
        var keyValue = new KeyValuePair<string, List<string>>(jsonData.word, jsonData.inRegion.ToList());
        return keyValue;
    }
}
