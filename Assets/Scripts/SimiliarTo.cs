...
public class SimiliarTo : MonoBehaviour
{
    ...
    {
        using (var request = UnityWebRequest.Get("https://wordsapiv1.p.rapidapi.com/words/"+ word +"/similarTo"))
        {
    ...
    KeyValuePair<string, List<string>> ParseJson(string json)
    {
        ...
        var keyValue = new KeyValuePair<string, List<string>>(jsonData.word, jsonData.similarTo.ToList());
        return keyValue;
    }
